...
public class SLLZadacha109 {
	
	public static int Zadacha109(SLL<Integer> lista) {
	...
	public static void main(String[] args) throws IOException {
		...
		int izbrisani=Zadacha109(lista1);
		
		System.out.println(lista1 + "; " + "izbrisani " + izbrisani + " jazli");
	}
